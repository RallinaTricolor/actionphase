...
SELECT id, title, description, gm_user_id, state, genre, start_date, end_date, recruitment_deadline, max_players, created_at, updated_at, is_anonymous, auto_accept_audience, allow_group_conversations, portrait_avatars, banner_url, common_room_open_day, common_room_open_time, common_room_close_day, common_room_close_time, schedule_timezone, character_sheet, community_id FROM games WHERE id = $1
`
...
SELECT games.id, games.title, games.description, games.gm_user_id, games.state, games.genre, games.start_date, games.end_date, games.recruitment_deadline, games.max_players, games.created_at, games.updated_at, games.is_anonymous, games.auto_accept_audience, games.allow_group_conversations, games.portrait_avatars, games.banner_url, games.common_room_open_day, games.common_room_open_time, games.common_room_close_day, games.common_room_close_time, games.schedule_timezone, games.character_sheet, games.community_id, COALESCE(users.username, 'Unknown') as gm_username,
...
SET title = $2, description = $3, genre = $4, start_date = $5,
    ...
    community_id = COALESCE($19::integer, games.community_id),
