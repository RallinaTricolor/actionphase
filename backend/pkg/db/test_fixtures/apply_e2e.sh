...
echo "  • Games 164-167: Common Room testing (posts, mentions, notifications)"
echo "  • Games 200-210: Action/Phase testing"
echo "  • Games 300-305: Character management testing"
echo "  • Games 400-404: Messaging testing"
echo ""
echo "Characteristics:"
echo "  • Predictable IDs for reliable tests"
echo "  • Isolated data (no cross-dependencies)"
