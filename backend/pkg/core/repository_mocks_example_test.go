...
// This test demonstrates both the simple mock and function-based mock approaches

func TestUserService_CreateUser_WithSimpleMock(t *testing.T) {
	t.Parallel() // Enable parallel execution

	// Simple mock provides basic functionality out of the box
...
func TestUserService_CreateUser_WithFunctionMock(t *testing.T) {
	t.Parallel() // Enable parallel execution

	// Function-based mock allows custom behavior per test
...
func TestGameService_CreateAndRetrieveGame(t *testing.T) {
	t.Parallel() // Enable parallel execution
...
func TestSessionService_CreateAndRetrieve(t *testing.T) {
	t.Parallel() // Enable parallel execution
...
func TestGameParticipantService_AddAndCheckParticipant(t *testing.T) {
	t.Parallel() // Enable parallel execution
...
// Example of testing error conditions with function-based mocks
func TestUserService_HandleErrors(t *testing.T) {
	t.Parallel() // Enable parallel execution
