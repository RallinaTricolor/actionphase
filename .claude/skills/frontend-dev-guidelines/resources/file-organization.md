...
ActionPhase uses a single alias for clean imports:

| Alias | Resolves To | Use For |
|-------|-------------|---------|
| `@/` | `src/` | All absolute imports from src root |
...
import { gameApi } from '@/features/games/api/gameApi';
...
- Lib utilities: `@/lib/api`
- Hooks: `@/hooks/useAuth`
- Components: `@/components/ui`
- Features: `@/features/games/api/gameApi`
- Types: `@/types/game`
...
4. Import alias for clean imports (@/)
