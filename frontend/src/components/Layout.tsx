              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                ...
                >
                  <button
                    ...
                    // at all. Clicking now opens it as well.
                    //
                    // Deliberately not a toggle: the wrapper's onMouseEnter has
                    // already set this open by the time a mouse click lands, so
                    // toggling closed the menu on every click and left it
                    // reachable only by keyboard. Closing is the wrapper's
                    // onMouseLeave, or picking an item.
            ...
            {isMobileMenuOpen && (
              <div className="pb-4 pt-2 border-t border-interactive-primary-hover">
                <div className="space-y-1">
                  ...
                  <Link
                    to="/favorites"
                    className={`block ${navLinkClass('/favorites')}`}
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <div className="flex items-center space-x-2">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
