...
import { GameApplicationsList } from './applications/GameApplicationsList';
import { PublicApplicantsList } from './applications/PublicApplicantsList';
import { GameExportPanel } from './GameExportPanel';
import { GameCommunitySection } from './GameCommunitySection';
import { PhaseManagement } from '@/components/phases/PhaseManagement';
import { ActionSubmission } from '@/components/actions/ActionSubmission';
import { ActionsList } from '@/components/actions/ActionsList';
import { ActionResultsList } from '@/components/actions/ActionResultsList';
import { GameResultsManager } from '@/components/actions/GameResultsManager';
import { CommonRoom } from '@/components/messages/CommonRoom';
import { PrivateMessages } from '@/components/conversations/PrivateMessages';
import { HistoryView } from '@/components/phases/HistoryView';
