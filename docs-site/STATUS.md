...
This file tracks the status of all feature documentation.
...
When a feature changes, update the corresponding file and change its status to **Stale** until reviewed. Update the "Last Updated" date when changes are made.
