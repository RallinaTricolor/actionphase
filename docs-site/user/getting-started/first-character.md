...
Congratulations on being accepted into a game! Now it's time to bring your character to life. This guide will walk you through creating your character sheet and getting ready for play.

## Character Creation Process

After your application is approved, you'll go through these steps:
...
Your character sheet is the central hub for everything about your character. It consists of several sections:
...
- Loyal to friends but slow to trust strangers
- Values honesty above politeness
- Afraid of deep water (nearly drowned as child)
- Always carries a lucky coin
- Goal: Find the truth about their father's disappearance
...
**Do:**
- Read the game's setting carefully
- Match the tone (serious, comedic, etc.)
- Connect to the game's themes
...
**Three-Dimensional Characters Have:**
...
**Good Characters:**
- Have reasons to engage with the story
- Can work with others (even if reluctantly)
...
❌ "Master of all weapons, speaks 12 languages, never fails"
✅ "Skilled with swords, learning archery, struggles with magic"

### The Mysterious Loner
❌ "Sits in the corner, says nothing, trusts no one"
✅ "Cautious with strangers but loyal once trust is earned"

### The Inflexible Concept
❌ "Will only do X, refuses to do Y under any circumstances"
✅ "Prefers X but will do Y if the situation demands it"

### The Novel-Length Backstory
❌ 10 pages of detailed history
✅ 2-3 paragraphs hitting key points, leaving room for discovery
...
If your GM requests changes:
- **Read carefully** - Understand what needs changing
- **Ask questions** - Clarify if unsure
- **Be flexible** - The GM knows their game best
...
Once approved:
- Your character is locked for play
...
Your first post is important! Consider:
- How your character enters the scene
- Their initial impressions
- What others notice about them
- An opening for interaction
...
- **Re-read** the game description
- **Look at** other approved characters (if visible)
- **Ask** your GM questions
- **Check** the game's house rules
- **Browse** the FAQ section

### Common Questions

**Q: Can I change my character after starting?**
A: Minor edits (typos, clarifications) yes. Major changes need GM approval.

**Q: How much detail is too much?**
A: Follow your GM's guidelines. When in doubt, be concise.

**Q: Can I have secrets in my backstory?**
A: Yes! Mark them as "GM Only" in your notes section.
...
With your character approved, you're ready to:
- [Understand the Common Room](../game-guide/common-room.md)
- [Learn about Action Phases](../game-guide/action-phase.md)
- [Manage your character](../game-guide/character-management.md)

---

**Remember:** Your character is your avatar in the game world. Make them interesting, make them fit, and most importantly, make them fun to play!
