...
- **Countdown** — Time remaining in days/hours/minutes
- **Color** — Red when under 6 hours, yellow for 6–24 hours, blue for further out, gray when expired
...
- **Title** — What this deadline is for (required)
